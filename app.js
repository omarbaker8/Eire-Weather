...
let counties = Object.keys(countyJsonMap); 
...
function displayWeather(forecast, county) {
    ...
    document.getElementById('today-tab').addEventListener('click', function() {
        ...
        document.querySelector('.bi-cloud-drizzle').style.color = '#212529'; 
    ...
    document.getElementById('tonight-tab').addEventListener('click', function() {
        ...
        document.querySelector('.bi-cloud-drizzle').style.color = '#F8F8FF'; 
        document.querySelector('h2').style.color = '#F8F8FF'; 
        updateDate(issuedDate, 0, county);
    });
...
//Code for rain animation : https://gist.github.com/CodeMyUI/01e817bb9500dc7e014d315676fb7de6
